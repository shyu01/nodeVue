...
export default {
  ...
  methods: {
    getReq () {
      axios.get('http://133.186.211.92:3000/api/user')
    ...
    postReq  () {
        axios.post('http://133.186.211.92:3000/api/user', {
        name: '가정', age: 10 // req.body
      })
        .then((r) => {
    ...
    putReq   () {
        axios.put('http://133.186.211.92:3000/api/user', {
        user: 'putMan'
      })
        .then((r) => {
    ...
    delReq   () {
        axios.delete('http://133.186.211.92:3000/api/user')
        .then((r) => {
  ...
  putUser () {
    this.dialog = false
    axios.put(`http://133.186.211.92:3000/api/user/${this.putId}`, {
      name: this.userName, age: this.userAge
    })
      .then((r) => {
        this.pop('사용자 수정 완료')
  ...
  delUser (id) {
    axios.delete(`http://http://133.186.211.92:3000/api/user/${id}`)
      .then((r) => {
        this.pop('사용자 삭제 완료')
        this.getUsers()
      })
